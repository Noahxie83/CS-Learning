...
class Message(object):
    def __init__(self, input_text):
        ...
        a Message object has one attribute:
            the message text
        '''
        self.message_text=input_text  # delete this line and replace with your code here
    ...
    def apply_pad(self, pad):
        ...
        '''
        result=[]
        for index,char in enumerate(self.message_text):
            shifted_char=self.shift_char(char,pad[index])
...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        '''
        return [random.randint(0,109)for _ in self.message_text]  # delete this line and replace with your code here
    ...
    def get_ciphertext(self):
        ...
        '''
        return self.ciphertext  # delete this line and replace with your code here
    ...
    def change_pad(self, new_pad):
        ...
        '''
        self.pad=new_pad[:]
        self.ciphertext=self.apply_pad(self.pad)  # delete this line and replace with your code here
...
class EncryptedMessage(Message):
    def __init__(self, input_text):
        ...
        '''
        super().__init__(input_text)  # delete this line and replace with your code here
    ...
    def decrypt_message(self, pad):
        ...
        '''
        decrypt_pad=[-shift for shift in pad]
        plaintext=self.apply_pad(decrypt_pad)  
